            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="flex flex-col my-5 gap-3 px-3">
                    ...
                    <div className="flex justify-center w-100% mt-4">
                        <Link href={'https://go.perfectpay.com.br/PPU38COEJ7L'} className="bg-white shadow-md border gap-5 border-gray-60 w-[90%] h-fit p-5 flex flex-col rounded-lg">
                            ...
                            <div className="flex flex-col">
                                <Link href={'https://go.perfectpay.com.br/PPU38COEJ7L'}>
